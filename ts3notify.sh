...
buildLink="[url=https://travis-ci.org/$TRAVIS_REPO_SLUG/builds/$TRAVIS_BUILD_ID]Build $TRAVIS_BUILD_ID[/url]"

# form a nice message
EscTS "Commit $commitLink in branch $TRAVIS_BRANCH ($buildLink) $ok."
